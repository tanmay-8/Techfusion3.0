const ShinyButton = () => {
    return (
        <div className="relative group">
            ...
            <button className="relative px-8 py-5 text-lg bg-black text-white font-medium rounded-full leading-none flex items-center justify-center space-x-6 transition-all duration-200">
